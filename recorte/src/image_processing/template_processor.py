...
class TemplateProcessor:
    ...
    def __init__(self, visualization_dir: str = "visualization_results"):
        ...
        self.template_data_path = Path(__file__).parent.parent.parent.parent / "resultados" / "analisis_regiones" / "dataset_entrenamiento_1" / "analisis" / "template_analysis_results.json" 
