...
def comparar_coordenadas():
    ...
    df_verdaderos = pd.read_csv('Tesis/coordenadas/coordenadas_prueba_1.csv', header=None)
    df_verdaderos.columns = [*range(df_verdaderos.shape[1]-1), 'nombre_imagen']
    
    # Leer el archivo JSON con las predicciones
    with open('Tesis/resultados/prediccion/dataset_1/lote/json/results.json', 'r') as f:
    ...
    df_resultados.to_csv('Tesis/resultados/prediccion/dataset_1/lote/comparacion/resultados_comparacion.csv', index=False)
