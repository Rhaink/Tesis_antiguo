...
def generate_search_zone(csv_file, coord_num):
    ...
    output_dir = "resultados/region_busqueda/dataset_entrenamiento_1/imagenes"
    os.makedirs(output_dir, exist_ok=True)

    plt.savefig(
        os.path.join(output_dir, f"coord{coord_num}_search_zone.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
...
# Ejecutar análisis
csv_file = "coordenadas/coordenadas_entrenamiento_1.csv"
all_search_zones = {}
...
output_dir_json = "resultados/region_busqueda/dataset_entrenamiento_1/json"
