...
test_image_path = base_dir / "COVID-19_Radiography_Dataset" / "Normal" / "images" / "Normal-5.png"
...
# tamaño de las imagenes en el entrenamiento (width, height)
...
if best_coord1_mse:
    output_image = mark_coordinate(output_image, best_coord1_mse, color=(255, 0, 0))  # Rojo para MSE
...
if best_coord1_euclidean:
    output_image = mark_coordinate(output_image, best_coord1_euclidean, color=(0, 255, 0))  # Verde para Euclidiana
