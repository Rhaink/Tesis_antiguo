...
PROJECT_ROOT = SCRIPT_DIR.parent.parent  # Directorio raíz del proyecto (un nivel más arriba)
...
class PulmoAlignViewer:
    ...
    def initialize_shared_components(self):
        ...
        self.image_processor = ImageProcessor(
            base_path=str(PROJECT_ROOT.parent / "COVID-19_Radiography_Dataset"),
            visualization_dir=str(PROJECT_ROOT.parent / "visualization_results")
        )
